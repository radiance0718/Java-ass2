                    ...
                    int len = instruct.length;
                        switch (instruct[0]){
                            case 'F':{
                                ...
                                System.out.println("F success in server");
                                break;
                            }
                            case 'S':{
                                ...
                                this.name = name;
                                System.out.println("Already get "+name+"'s name");
                            ...
                            case 'M' : {
                                System.out.println(String.valueOf(instruct).trim());
                                Message mes = Message.getMessage(String.valueOf(instruct).trim().substring(1));
                                System.out.println("get message:" + mes.toString());
                                String to = mes.getSendTo();
                                if(userlist.get(to) != null){
                                    System.out.println("Send: "+mes.toString());
                                    userlist.get(to).outs.write(("M"+mes.toString()).getBytes(StandardCharsets.UTF_8));
                                    userlist.get(mes.getSentBy()).outs.write(("M"+mes.toString()).getBytes(StandardCharsets.UTF_8));
                                    ...
                                    for(int i = 0;i < users.size();i++){
                                        users.get(i).outs.write(("M"+mes.toString()).getBytes(StandardCharsets.UTF_8));
